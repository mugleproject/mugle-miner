...
pub struct MugleMinerPluginConfig {
...
impl Default for MugleMinerPluginConfig {
	fn default() -> MugleMinerPluginConfig {
		MugleMinerPluginConfig {
...
pub struct MinerConfig {
	...
	pub miner_plugin_config: Vec<MugleMinerPluginConfig>,
}
