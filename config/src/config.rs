...
use types::{ConfigError, ConfigMembers, GlobalConfig, MugleMinerPluginConfig};
...
const CONFIG_FILE_NAME: &str = "mugle-miner.toml";
...
/// Transforms a set of mugle-miner plugin configs to cuckoo-miner plugins configs
pub fn read_configs(
	plugin_dir: Option<PathBuf>,
	conf_in: Vec<MugleMinerPluginConfig>,
