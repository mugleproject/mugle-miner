...
extern crate mugle_miner_config as config;
extern crate mugle_miner_plugin as plugin;
extern crate mugle_miner_util as util;
...
pub fn info_strings() -> (String, String, String) {
	(
		format!(
			"This is Mugle-Miner version {}{}, built for {} by {}.",
...
mod with_tui {
	...
	pub fn start_tui(
		...
		println!("Starting Mugle Miner in UI mode...");
...
fn main() {
	...
	println!(
		"Starting Mugle-Miner from config file at: {}",
	...
	if mining_config.run_tui {
		...
		#[cfg(not(feature = "tui"))]
		warn!(LOGGER, "Mugle-miner was built with TUI support disabled!");
	} else {
